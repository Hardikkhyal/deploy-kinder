...
start "DevOpsHub Backend" cmd /k "cd /d "%~dp0DevOpsHub\backend" && npm install && npx prisma generate && npm run dev"

echo Starting Frontend UI (Port 5173)...
start "DevOpsHub Frontend" cmd /k "cd /d "%~dp0DevOpsHub\frontend" && npm install framer-motion lucide-react && npm install && npm run dev"
